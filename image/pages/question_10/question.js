...
Page({
  ...
  data: {
    ...
    time: 0, //录音时长
    tempFilePath: "", //音频路径
    content: '第10题 请您在一分钟内说出尽可能多的动物',
    question:'第10题 请您在一分钟内说出尽可能多的动物',//滚动条内容
    status:0,
    voice_path:String,
    result: String,
  ...
  gotoPage1:function(options){
    wx.redirectTo({
      url: '../../pages/question_9.2/question',
    })
  },

  gotoPage2:function(options){
    wx.setStorageSync('10', this.data.result)
    wx.setStorageSync('10_1', this.data.voice_path)
    wx.redirectTo({
      url: '../../pages/question_11.2/question',
    })
  },
