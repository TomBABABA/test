...
Page({
   ...
   */
  data: {
    content: '第11题,第二问。。请说出手表和尺子的共同点',//滚动条内容
    question:'第11.2题 请说出手表和尺子的共同点',
    status:0,
    voice_path:String,
    result: String,
  ...
  gotoPage1:function(options){
    wx.setStorageSync('11.2', this.data.result)
    wx.setStorageSync('11.2_1', this.data.voice_path)
    wx.redirectTo({
      url: '../question_12/question',
    })
  },
