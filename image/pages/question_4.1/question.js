...
Page({
   ...
   */
  data: {
    content: '第4题 第一问，请说出图中的动物',//内容
    question:'第4题 第一问，请说出图中的动物',
    status:0,
    voice_path: String,
    result: String,
  ...
  gotoPage1: function() {
    wx.redirectTo({
      url: '../../pages/question_3.3/question_3.3',
    })
  },
  gotoPage2: function() {
   ...
   var answer = {
     ...
     wx.setStorageSync('4.1-1', this.data.voice_path)
    wx.setStorageSync('4.1-2', answer)
    wx.redirectTo({
      url: '../../pages/question_4.2/question',
    })
