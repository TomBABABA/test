...
Page({
   ...
   */
  data: {
    content: '第4题 第三问，请说出图中的动物',//内容
    question:'第4题 第三问，请说出图中的动物',
    status:0,
    voice_path: String,
    result: String,
  ...
  gotoPage2: function() {
   ...
   var answer = {
     ...
     wx.setStorageSync('4.3-1', this.data.voice_path)
    wx.setStorageSync('4.3-2', answer)
    wx.redirectTo({
      url: '../../pages/question_5/question',
    })
