...
Page({
   ...
   */
  data: {
    content: '第9题，第1问。。您将听到一个句子。。播放结束后，请重复您所听到的句子',//语音播放的内容
    question:'第9.1题 请重复您所听到的句子',//滚动条内容
    one_phrase:'我只知道今天张亮是来帮过忙的人',
    status:0,
    voice_path:String,
    result: String,
  ...
  gotoPage1:function(options){
    wx.redirectTo({
      url: '../question_8/question',
    })
  },
 
  gotoPage2:function(options){
    wx.setStorageSync('9.1', this.data.voice_path)
    wx.setStorageSync('9.1_1', this.data.result)
    wx.redirectTo({
