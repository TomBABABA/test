// pages/question_b10.1/question_b10.1.js
...
Page({
   ...
   */
  data: {
    content: '第10.1题 请按行说出圆形中的数字',//内容
    question:'第10.1题 请按行说出圆形中的数字',
    status:0,
    record_status: 0,
  ...
  gotoPage1: function() {
    wx.redirectTo({
      url: '../../pages/question_b9.4/question',
    })
  },
  gotoPage2: function() {
    wx.redirectTo({
      url: '../../pages/question_b10.2/question_b10.2',
    })
    var answer = {
      text: this.data.result,
    }
    console.log(answer)
    wx.setStorageSync('b10.1', this.data.voice_path)
    wx.setStorageSync('b10.1_text', answer)
  },
