...
Page({
   ...
   */
  data: {
    content: '第2题 请正确读出以下五个词语 ',//语音播放的内容
    question:'第2题 请正确读出以下五个词语 ',//滚动条内容
    one_phrase:'梅花。。。。。。。萝卜。。。。。。。沙发。。。。。。。蓝色。。。。。。。筷子。。。。。',//点击播放之后播放的内容
    status:0,
    voice_path: String,
    result: String,
  ...
  gotoPage1:function(options){
    wx.redirectTo({
      url: '../../pages/question_b1/question_b1',
    })
  },
  ...
  gotoPage2:function(options){
    var answer = {
     ...
     wx.setStorageSync('b2-1', this.data.voice_path)
    wx.setStorageSync('b2-2', answer)
