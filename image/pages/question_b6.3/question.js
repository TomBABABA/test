...
Page({
   ...
   */
  data: {
    content: '第6.3题 请回答北方和南方属于什么类别',
    question:'第6.3题，请回答北方和南方属于什么类别',//滚动条内容
    status:0,
    voice_path:String,
    result: String,
  ...
  gotoPage1:function(options){
    wx.setStorageSync('b6.3', this.data.voice_path)
    wx.setStorageSync('b6.3_1', this.data.result)
    wx.redirectTo({
      url: '../question_b7/question',
    })
  },
