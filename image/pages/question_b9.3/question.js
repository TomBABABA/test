...
Page({
   ...
   */
  data: {
    content: '第9题 第三问，请说出图中的动物',//内容
    question:'第9题 第三问，请说出图中的动物',
    status:0,
    voice_path: String,
  ...
  gotoPage1: function() {
    wx.redirectTo({
      url: '../../pages/question_b9.2/question',
    })
  },
  gotoPage2: function() {
    var answer = {
     ...
     wx.setStorageSync('b9.3-1', this.data.voice_path)
    wx.setStorageSync('b9.3-2', answer)
    wx.redirectTo({
